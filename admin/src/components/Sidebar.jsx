...
const Sidebar = () => {
    return (
        <div className='py-7 flex justify-center gap-x-2 gap-y-5 w-full bg-white sm:gap-x-4 lg:flex-col lg:pt-20 lg:max_w_60 lg:h-screen lg:justify-start lg: pl-6'>
            <Link to={'/addproduct'}>
